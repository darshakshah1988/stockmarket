...
def generate_signal(df):
    ...
    if vol < VOL_THRESHOLD_RATIO * avg_vol:
        return "No Signal (Low Volume)", vol, None, None, None, None, avg_vol
...
def run_signal_check(sheet=None):
    try:
        ...
        # Log and alert only for significant volume movement
        if vol >= VOLUME_LOG_THRESHOLD:
            ...
            if volume_spike:
                ...
                print("⚪ Minor volume change — no Telegram alert.")
        else:
            print("⚠️ Volume below 160, not logged.")
...
if __name__ == "__main__":
    print("🚀 BTCUSD Supertrend Bot (15-Min Schedule + Major Volume Alerts) running...\n")
